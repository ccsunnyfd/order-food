  ...
  <div id="order">
    <div class="order_content" v-if="list.total_num">
      <div class="order_info">
        ...
        <h3>
          已点菜品{{ list.total_num }}份,合计 :
          <span class="price">{{ list.total_price }}元</span>
        </h3>
      ...
      <div class="order_list">
        <h3>菜品详情:</h3>
        <ul class="list">
          <li v-for="item in list.items" :key="item._id">
    ...
    <div v-if="!list.total_num" class="cart_empty">
      您还没有点餐，点击菜单开始点菜
    </div>
...
export default {
  ...
  methods: {
    ...
    doWeixinPay() {
      ...
      location.href =
        "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx7bf3787c783116e4&redirect_uri=http://b.itying.com?order_id=" +
        order_id +
