  ...
  <div id="cart">
    <div class="cart_content">
      <div class="cart_info" v-if="totalNum">
        ...
        <div class="p_number">
          <div class="p_number_left">
            ...
            <p>
              备注:<span v-if="!peopleList.p_mark">无</span
        ...
        <div class="cart_p_num">
          ...
          <p>
            合计：<span class="price">¥{{ allPrice }}</span>
          </p>
        </div>
      </div>
      ...
      <div class="cart_list" v-if="totalNum">
        <ul>
          <li class="item" v-for="(item, key) in list" :key="item._id">
            <div class="left_food">
      ...
      <div v-if="!totalNum" class="cart_empty">
        您的购物车空空的，点击菜单开始点菜
      </div>
    </div>
...
export default {
  data() {
    return {
      ...
      // list: [
      //   {
      //     _id: "5c343b7fcfa5ce0f340b00b8",
      //     uid: "1",
      //     title: "香酥黄金鱼",
      //     price: "22",
      //     product_id: "5ac1eb591a6b2f48fcb06210",
